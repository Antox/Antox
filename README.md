...
###Translating Antox
In the past, translating using Transifex was possible - currently there's an ongoing transition to Weblate - until it's done, translations are accepted via pull requests.
