...
/*
 * THIS IS HERE BECAUSE ANDROID VIEW PAGERS HAVE NO WAY TO GET THE CURRENTLY SELECTED FRAGMENT.
 * FEEL FREE TO REMOVE THIS WHEN GOOGLE GETS THIER ACT TOGETHER.
 */
package chat.tox.antox.pager;
 ...
 * complete}
 */
public abstract class BetterFragmentPagerAdapter extends PagerAdapter {
    private static final String TAG = BetterFragmentPagerAdapter.class.getSimpleName();
