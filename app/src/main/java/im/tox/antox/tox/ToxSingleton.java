...
public class ToxSingleton {
    ...
    public HashMap<Integer, ArrayList<Tuple<Integer,Long>>> progressHistoryMap = new HashMap<Integer, ArrayList<Tuple<Integer,Long>>>();
    ...
    public HashMap<Integer, FileOutputStream> fileStreamMap = new HashMap<Integer, FileOutputStream>();
